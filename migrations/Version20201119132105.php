 ...
 */
final class Version20201119132105 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE house ADD house_roofing_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_67D5399D24D9B445');
        $this->addSql('ALTER TABLE house DROP house_roofing_id');
    }
}
