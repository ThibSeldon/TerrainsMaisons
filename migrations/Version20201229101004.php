 ...
 */
final class Version20201229101004 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE SEQUENCE id INCREMENT BY 1 MINVALUE 10 START 10');
        ...
        $this->addSql('CREATE TABLE allotment (id INT NOT NULL, name VARCHAR(255) NOT NULL, postal_code INT NOT NULL, city VARCHAR(255) NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, property_limit DOUBLE PRECISION DEFAULT NULL, double_limit BOOLEAN NOT NULL, local_urban_plan_file VARCHAR(255) DEFAULT NULL, regulation_file VARCHAR(255) DEFAULT NULL, is_valid BOOLEAN NOT NULL, allotment_plan_file VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
