 ...
 */
final class Version20210128131505 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE allotment ADD sanitation_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_B8F53CB54BA400F3');
        $this->addSql('ALTER TABLE allotment DROP sanitation_id');
    }
}
